...
class Cam(Node):
    ...
    def _tf_cb(self, msg):
        global current_yaw, robot_x, robot_y
...
def main():
    ...
    try:
        ...
        # 对齐Y轴正向进入S弯
        print("  对齐Y轴正向，进入S弯")
        align_yaw(target_yaw=math.pi/2, tolerance=math.radians(3))
    ...
    # 启动nav_relative.py
    import os
    os.execvp('python3', ['python3', '/home/cyberdog_sim/nav_relative.py'])
