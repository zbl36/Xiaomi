...
void ConvexMpcLocoGaits::SetCmdScale() {
    ...
    if ( user_params_->vel_scale_limit_type < 0.9 ) {
        ...
        if ( vel_des_last_( 0 ) >= 0.0 ) {
            ...
            // rpy_cmd_scale_( 1 ) *= fabs( vel_des_last_( 0 ) ) * user_params_->x_effect_scale_pos + 1.0;  // pitch (disabled for camera view)
        }
        else {
            ...
            // rpy_cmd_scale_( 1 ) *= fabs( vel_des_last_( 0 ) ) * user_params_->x_effect_scale_neg + 1.0;  // pitch (disabled for camera view)
        }
        ...
        // rpy_cmd_scale_( 1 ) *= fabs( vel_des_last_( 2 ) ) * user_params_->yaw_effect_scale[ 2 ] + 1.0;  // pitch (disabled for camera view)

        // y_dot has effect on yaw_dot and pitch
        vel_cmd_scale_( 2 ) *= fabs( vel_des_last_( 1 ) ) * user_params_->y_effect_scale + 1.0;  // yaw_dot
        // rpy_cmd_scale_( 1 ) *= fabs( vel_des_last_( 1 ) ) * user_params_->y_effect_scale + 1.0;  // pitch (disabled for camera view)
